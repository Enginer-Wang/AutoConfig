...
> 一站式教育互动平台 — 静态网页托管、班级管理、作业系统、模板商城与社区互动。

---

## 📖 项目简介

**Autoconfig** 是一个面向教育场景的全功能互动平台，集静态网页托管、班级与学生管理、作业发布批改、课件展示、模板商城、社区广场、聊天系统和管理后台于一体。适合教师创建互动课件并管理班级教学，也适合学生展示个人项目和参与学习互动。
...
| � **班级管理** | 创建/加入班级、邀请码机制、协作教师、学生管理、数据分析可视化 |
| 📝 **作业系统** | 教师发布/编辑/删除作业、学生提交、教师批改打分、成绩统计 |
| 📢 **班级公告** | 教师发布普通/紧急公告、学生控制台实时展示 |
| 🎯 **练习系统** | 课件互动练习、成绩记录、排行榜 |
...
- `/classes` — 班级管理（总览、学生管理、公告、数据分析）
- `/homework` — 作业中心（发布/提交/批改/编辑/删除）
- `/editor/:id` — 模板源码编辑器
...
homework            — 作业表（标题、描述、截止日期、满分）
homework_submissions — 作业提交表（内容、得分、评语、状态）
...
│       ├── classes.js        # 班级管理、成员、公告、数据分析
│       ├── homework.js       # 作业发布、提交、批改、编辑删除
